...
const Process = ({ valuePercent, icon, activity, height }) => {
  ...
  return (
    <div className={`flex 2xl:flex-row md:flex-col sm:flex-col  bg-blue-200 md:w-3/4 lg:w-2/3 h-40 rounded-lg mx-auto sm:items-center md:items-center 2xl:gap-3 `}>
