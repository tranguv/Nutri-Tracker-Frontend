...
const Dasboard = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center gap-8 mt-10 mb-10 mx-16 ">
        {" "}
        {/* Added gap-8 for consistent vertical spacing */}
        ...
        <div className="flex w-full gap-10">
          {" "}
          {/* Added gap-10 for horizontal gap */}
          <div className="w-2/3">
            <div className="flex flex-col justify-center mt-8 gap-6">
              {" "}
              {/* Added gap-6 for vertical gap */}
          ...
          <div className="flex flex-col w-1/3 mt-8 gap-6">
            {" "}
            {/* Added gap-6 for vertical gap */}
            <Process valuePercent="90" activity="Steps" />
            <div className="h-36 bg-gray-300 rounded-lg"></div>
